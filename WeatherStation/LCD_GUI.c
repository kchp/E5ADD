...
void Test_Fonts(void)
{
	...
	printf("Draw font sizes\n");
	GUI_DisString_EN(10,10,"FONT 24",&Font24,GUI_BACKGROUND,CYAN);
	GUI_DisString_EN(10,40,"FONT 20",&Font20,GUI_BACKGROUND,CYAN);
	GUI_DisString_EN(10,65,"FONT 16",&Font16,GUI_BACKGROUND,CYAN);
	GUI_DisString_EN(10,86,"FONT 12",&Font12,GUI_BACKGROUND,CYAN);
	GUI_DisString_EN(10,103,"FONT  8",&Font8,GUI_BACKGROUND,CYAN);
...
void Test_Background(void)
{
	...
	printf("Draw background colours\n");
	GUI_DrawRectangle(0,0,159,127,BLACK,DRAW_EMPTY,DOT_PIXEL_2X2);
	GUI_DisString_EN(10,30,"Background",&Font20,GUI_BACKGROUND,CYAN);
	GUI_DisString_EN(10,50,"Colours",&Font20,GUI_BACKGROUND,CYAN);
	delay_ms(DELAY);
	LCD_Clear(WHITE);
	LCD_Clear(BLUE);
	LCD_Clear(GREEN);
