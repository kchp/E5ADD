...
################################################################
# This is a generated script based on design: mz_weather
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ARDUINO_IO7 [ create_bd_port -dir O -from 0 -to 0 ARDUINO_IO7 ]
  set ARDUINO_IO8 [ create_bd_port -dir O -from 0 -to 0 ARDUINO_IO8 ]
  set ARDUINO_IO9 [ create_bd_port -dir O -from 0 -to 0 ARDUINO_IO9 ]
  set ARDUINO_IO10 [ create_bd_port -dir O -from 0 -to 0 ARDUINO_IO10 ]
  set ARDUINO_IO11 [ create_bd_port -dir O ARDUINO_IO11 ]
  set ARDUINO_IO12 [ create_bd_port -dir I ARDUINO_IO12 ]
  set ARDUINO_IO13 [ create_bd_port -dir O ARDUINO_IO13 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net ARDUINO_IO12_1 [get_bd_ports ARDUINO_IO12] [get_bd_pins axi_quad_spi_0/io0_i]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_ports ARDUINO_IO9] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports ARDUINO_IO8] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_iic_0_gpo [get_bd_ports ARDUINO_IO7] [get_bd_pins axi_iic_0/gpo]
  connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins axi_iic_0/iic2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net axi_quad_spi_0_io1_o [get_bd_ports ARDUINO_IO11] [get_bd_pins axi_quad_spi_0/io1_o]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_ports ARDUINO_IO13] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports ARDUINO_IO10] [get_bd_pins axi_quad_spi_0/ss_o]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
